      ...
      <ConnectKitButton.Custom>
        {({ show }) => (
          ...
          >
            ...
            <span className="hidden sm:inline">{t("web3.connectWallet")}</span>
        ...
        >
          ...
          <div className="p-4 border-b border-slate-700/50">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                  <span className="text-sm font-semibold text-slate-100">{t("web3.connected")}</span>
          ...
          <div className="p-4 border-b border-slate-700/50">
            <div className="grid grid-cols-2 gap-3">
              <div className="rounded-lg bg-slate-900/60 p-2.5">
                <p className="text-[9px] text-slate-500 uppercase tracking-wider mb-1">{t("web3.balance")}</p>
                <p className="text-sm font-semibold text-emerald-300 font-mono">{balance}</p>
              </div>
              <div className="rounded-lg bg-slate-900/60 p-2.5">
                <p className="text-[9px] text-slate-500 uppercase tracking-wider mb-1">{t("web3.valuation")}</p>
          ...
          <div className="p-2">
            ...
            >
              ...
              {t("web3.switchNetwork")} {chainId === 8453 ? 'Base Sepolia' : 'Base Mainnet'}
            </DropdownMenuItem>
    ...
    <ConnectKitButton.Custom>
      {({ show }) => (
        <button
          ...
          aria-label={t("web3.walletConnected")}
        >
